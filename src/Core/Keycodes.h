...
#define VKTB_MOUSE_BUTTON_LAST VKTB_MOUSE_BUTTON_8
#define VKTB_MOUSE_BUTTON_LEFT VKTB_MOUSE_BUTTON_1
#define VKTB_MOUSE_BUTTON_RIGHT VKTB_MOUSE_BUTTON_2
#define VKTB_MOUSE_BUTTON_MIDDLE VKTB_MOUSE_BUTTON_3

#define VKTB_RELEASE 0
#define VKTB_PRESS 1
#define VKTB_REPEAT 2